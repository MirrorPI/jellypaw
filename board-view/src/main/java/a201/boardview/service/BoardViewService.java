...
public class BoardViewService {
    ...
    public List<BoardView> getAllBoards() {
        ...
        return boardViewRepository.findAll();
    }
    ...
    public List<BoardView> getBoardsByCursor(LocalDateTime cursorCreatedAt, Long cursorId, Pageable pageable) {

        Slice<BoardView> boardSlice = boardViewRepository.findSliceByCursorWithFetchJoin(cursorCreatedAt, cursorId, pageable);
