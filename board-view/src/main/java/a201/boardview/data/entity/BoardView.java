...
public class BoardView {
    ...
    @JsonIgnore
    @OneToOne(mappedBy = "boardId", cascade = CascadeType.ALL, fetch = FetchType.LAZY)
    ...
    @OneToMany(mappedBy = "boardView", cascade = CascadeType.ALL, orphanRemoval = true, fetch = FetchType.LAZY)
    @Builder.Default
